...
class ArFragment : Fragment(R.layout.fragment_ar) {
    ...
    private val measurementList: ArrayList<String> = arrayListOf()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.txtDistance.text = "Current Distance:"
        binding.txtLastDistance.text = "Last Distance:"
...
//            viewModel.setRenderAble(pointRender, widthLineRender, heightLineRender)
//            findNavController().navigate(R.id.action_arFragment_to_sceneViewFragment)
    ...
    private fun showMeasureList() {
//        val children: List<Node> = java.util.ArrayList(arFragment.arSceneView.scene.children)
...
//        totalLength = 0f
    ...
    private fun addFromAim() {
        if (anchorNodeTemp != null) {
            binding.txtLastDistance.text = "Last Distance: $lastDistance"
            measurementList.add(lastDistance)
    ...
    private fun addDistanceCard(
        ...
        lastDistance = metersString
        binding.txtDistance.text = "Current Distance: $metersString"
