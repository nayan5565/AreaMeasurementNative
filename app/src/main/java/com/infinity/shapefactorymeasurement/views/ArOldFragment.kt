...
import com.infinity.shapefactorymeasurement.databinding.FragmentArOldBinding

import java.util.*
import kotlin.collections.ArrayList


class ArOldFragment: Fragment(R.layout.fragment_ar_old) {
    ...
    lateinit var binding: FragmentArOldBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding = FragmentArOldBinding.bind(view)
